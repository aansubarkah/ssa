...
async function getData() {
  try {
    let data = await fetchAsync(api_url);
    data_get = data;
    console.log(data); // You can use the data variable here
  } catch (reason) {
...
//csvData = jsonToCSV(data_get.data);

// -------- step 2: download the csv --------

//console.log(csvData);

//document.head.innerHTML += '<script src="https://cdn.jsdelivr.net/npm/convert-json-to-csv@1.0.0/index.min.js"></script>'

//var jsonToCsv = require('convert-json-to-csv');
//var arrayOfArraysCsv = jsonToCsv.getArrayOfArrays(data_get);
